...
public class FriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        c = (Button) rootView.findViewById(R.id.footer);
        initializeData();
        ...
        c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ParseUser currents = ParseUser.getCurrentUser();
                showAddDialog();
            }
        });
        if(friends!=null) {
    ...
    protected void showAddDialog() {
        ...
        View promptView = layoutInflater.inflate(R.layout.prompt_add_class, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getContext());
        alertDialogBuilder.setView(promptView);

        final EditText editText = (EditText) promptView.findViewById(R.id.editTextadd);
